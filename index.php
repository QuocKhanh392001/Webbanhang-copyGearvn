...
<div id="main">	
	<div id="danhmucsanpham">
		<form action="#"><button>Laptop</button></form>
	...
	while ($data = mysqli_fetch_array($result)) {
		echo'<div id="sanpham">
		<div id="sanpham_hinh"><a href="#"><div id="deal"><img src="img/'.$data['hinhanh'].'" width="100%" height="100%" alt=""></div></a></div>
		<div id="sanpham_ten"><a href="#">'.$data['tensanpham'].'</a></div>
		<div id="sanpham_giagiam">'.$data['giagiam'].'</div>
		<div id="sanpham_giatien">'.$data['giatien'].'</div>
	</div>';
		}
	?>
	<div id="banner">
